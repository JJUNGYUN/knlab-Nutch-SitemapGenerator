...
public class InlinkUpdateMapper extends GoraMapper<String, WebPage, UrlWithScore, NutchWritable> {
  ...
  public void map(String key, WebPage page, Context context) throws IOException, InterruptedException {
    ...
    if (outlinks != null) {
      for (Entry<Utf8, Utf8> e : outlinks.entrySet()) {
        ...
        Utf8 depthUtf8=page.getFromMarkers(InlinkUpdaterJob.DISTANCE);

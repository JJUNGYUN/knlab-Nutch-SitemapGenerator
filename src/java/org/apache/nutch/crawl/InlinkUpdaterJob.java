...
public class InlinkUpdaterJob extends NutchTool implements Tool {
  ...
  public InlinkUpdaterJob() {

  }

  public InlinkUpdaterJob(Configuration conf) {
    setConf(conf);
  }
  ...
  public Map<String,Object> run(Map<String,Object> args) throws Exception {
    ...
    StorageUtils.initMapperJob(currentJob, fields, UrlWithScore.class, NutchWritable.class, InlinkUpdateMapper.class);
    StorageUtils.initReducerJob(currentJob, InlinkUpdateReducer.class);
  ...
  private int updateTable(String crawlId) throws Exception {
    LOG.info("InlinkUpdaterJob: starting");
    run(ToolUtil.toArgMap(Nutch.ARG_CRAWL, crawlId));
    LOG.info("InlinkUpdaterJob: done");
    return 0;
  }
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(NutchConfiguration.create(), new InlinkUpdaterJob(), args);
    System.exit(res);
  }
